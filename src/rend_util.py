...
def load_mask(path):
    ...
    object_mask = alpha > 0
    # imsave(path,img_as_uint(object_mask))
    # print(object_mask.max(),object_mask.min())
    return object_mask
